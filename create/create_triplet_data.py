...
def get_test_data(res_num, src_num, X, Y, shape=None):
    res_X = []
    res_Y = []
...
def create_triplet_data(npz_path, dest_path):
    ...
    # create test data
    test_X, test_Y = get_test_data(test_num, src_test_num, src_test_X, src_test_Y, shape=(28, 28))
